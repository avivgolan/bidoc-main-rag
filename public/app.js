...
import { cleanChatUrl, renderChatMarkdown } from "./chatMarkdown.js?v=20260725-invoice-link1";
...
function renderWorkflow(workflow) {
  ...
  if (workflowHint) workflowHint.style.display = hasRun ? "none" : "block";
  if (workflowBoard) workflowBoard.classList.toggle("hasWorkflow", hasRun);
