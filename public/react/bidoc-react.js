...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function D(e, r, i, a, o) {
		...
		if (c) return o = o(e), c = a === "" ? "." + T(e, 0) : a, ee(o) ? (i = "", c != null && (i = c.replace(ae, "$&/") + "/"), D(o, r, i, "", function(e) {
			return e;
		})) : o != null && (w(o) && (o = re(o, i + (o.key == null || e && e.key === o.key ? "" : ("" + o.key).replace(ae, "$&/") + "/") + c)), r.push(o)), 1;
		c = 0;
		var l = a === "" ? "." : a + ":";
		if (ee(e)) for (var u = 0; u < e.length; u++) a = e[u], s = l + T(a, u), c += D(a, r, i, s, o);
		else if (u = m(e), typeof u == "function") for (e = u.call(e), u = 0; !(a = e.next()).done;) a = a.value, s = l + T(a, u++), c += D(a, r, i, s, o);
		else if (s === "object") {
	...
	function Ha(e) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				...
				if (se(t) || E(t)) return t = bi(t, e.mode, n, null), t.return = e, t;
	...
	function Ds(e, t, n, r) {
		...
		var a = Os(e).queue;
		Ts(e, a, t, ce, n === null ? Es : function() {
			return ks(e), n(r);
		});
	}
	function Os(e) {
	...
	function Pc(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 27: return ve(t), e === null && N && (r = t.stateNode = ff(t.type, t.pendingProps, me.current), Bi = t, Hi = !0, a = M, Zd(t.type) ? (lf = a, M = cf(r.firstChild)) : M = a), oc(e, t, t.pendingProps.children, n), gc(e, t), e === null && (t.flags |= 4194304), t.child;
		...
		switch (Ri(t), t.tag) {
			...
			case 27:
				if (ye(t), n = me.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Fc(t);
					...
					e = fe.current, qi(t) ? Gi(t, e) : (e = ff(a, r, n), t.stateNode = e, Fc(t));
				}
				return H(t), null;
			case 5:
			...
			case 19:
				...
				return r.tail === null ? (H(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Me(), e.sibling = null, n = F.current, j(F, a ? n & 1 | 2 : n & 1), N && Fi(t, r.treeForkCount), e);
			case 22:
	...
	function Au(e, t) {
		...
		while (1);
		return $i = Qi = null, O.H = r, O.A = a, G = n, q === null ? (K = null, J = 0, si(), X) : 0;
	}
	function ju() {
		for (; q !== null && !Ae();) Mu(q);
	}
...
var ae = ({ path: e, size: t = 16, ...n }) => /* @__PURE__ */ (0, x.jsx)("svg", {
	width: t,
	height: t,
	viewBox: "0 0 24 24",
	fill: "none",
...
function D({ label: e, hint: t, info: n, children: r, wide: i }) {
...
var O = "0 0 0 3px rgba(63, 141, 104, .16)";
function k({ value: e, onChange: t, type: n = "text", placeholder: r, min: i, max: a, step: o, style: s }) {
...
function ce({ value: e, onChange: t, children: n, style: r }) {
...
function le({ label: e, checked: t, onChange: n, info: r }) {
	return /* @__PURE__ */ (0, x.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, x.jsx)("button", {
			...
			children: [e, r && /* @__PURE__ */ (0, x.jsx)(oe, {
				text: r,
				label: e
			})]
		})]
...
function ue({ value: e, onChange: t, rows: n = 6, placeholder: r }) {
	let [i, a] = (0, b.useState)(!1);
...
function de({ label: e, value: t, onChange: n, placeholder: r, hint: i, info: a }) {
	let [o, s] = (0, b.useState)(!1);
	return /* @__PURE__ */ (0, x.jsx)(D, {
		label: e,
		hint: i,
		info: a,
...
function A({ title: e, children: t, defaultOpen: n = !1 }) {
	...
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, x.jsxs)("button", {
			...
			children: [e, /* @__PURE__ */ (0, x.jsx)(ae, {
				path: T.chevronDown,
				size: 14,
				style: {
...
function fe({ value: e, onChange: t, models: n, includeEmbedding: r = !1 }) {
	return /* @__PURE__ */ (0, x.jsxs)(ce, {
		value: e,
		onChange: t,
		...
		children: [
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, x.jsx)(j, { ok: n?.openRouter }), /* @__PURE__ */ (0, x.jsx)("span", {
						style: {
							fontSize: 12.5,
							color: "var(--text-secondary)"
						},
			...
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("p", {
				...
				children: [
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)(j, { ok: n?.supabase }), /* @__PURE__ */ (0, x.jsx)("span", {
							style: {
								fontSize: 12.5,
								color: "var(--text-secondary)"
							},
...
function me({ agent: e, models: t, form: n, update: r }) {
...
function he({ models: e, form: t, update: n, onRefreshModels: r, modelStatus: i }) {
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		style: E.section,
		children: [/* @__PURE__ */ (0, x.jsxs)("div", {
			style: {
			...
			children: [/* @__PURE__ */ (0, x.jsx)(se, { children: "כל מה שמשפיע על תשובות הצ׳אט: מודלים, פרומפטים, הגדרות temperature ו-maxTokens לכל סוכן. השאר שדה ריק כדי להשתמש בפרומפט ברירת המחדל מ-prompts.js." }), /* @__PURE__ */ (0, x.jsxs)("div", {
				style: {
					display: "flex",
					alignItems: "center",
					gap: 10,
			...
			children: S.map((r) => /* @__PURE__ */ (0, x.jsx)(me, {
				agent: r,
				models: e,
				form: t,
				update: n
...
function ge({ models: e, form: t, update: n }) {
	return e.filter((e) => e.id?.includes("embed") || e.id?.includes("text-embed")), /* @__PURE__ */ (0, x.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, x.jsx)(se, { children: "קובע כמה מקורות וכמה טקסט מכל מקור נכנסים בפועל לתשובת ה-AI. השורות מצטמצמות לאורך המשפך: אחזור ראשוני → דירוג מחדש → context שנכנס לסוכן הראשי." }),
				/* @__PURE__ */ (0, x.jsx)("div", {
					style: {
						...E.card,
						marginTop: 10
			...
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, x.jsx)(se, { children: "קובע האם וכמה קשרים מגרף הפרויקט ייכנסו לשאלות RAG — קישורי לוח זמנים, קשרי ישויות ואיתותים." }),
				/* @__PURE__ */ (0, x.jsxs)("div", {
					style: {
						...E.card,
						marginTop: 10,
...
function _e({ form: e, update: t, configStatus: n }) {
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		style: E.section,
		children: [
			/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsx)(j, { ok: n?.contentSupabase }), /* @__PURE__ */ (0, x.jsx)("span", {
					style: {
						fontSize: 12.5,
						color: "var(--text-secondary)"
					},
			...
			/* @__PURE__ */ (0, x.jsx)(se, { children: "Content Supabase משמש רק לשליפת תוכן: RAG, timeline ו-alerts. אם URL או Key ריקים, המערכת תשתמש ב-App Supabase הקיים." })
		]
	});
}
function ve({ form: e, update: t }) {
	...
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		style: E.section,
		children: [
			/* @__PURE__ */ (0, x.jsx)(se, { children: "כתובת ה-n8n Base URL משמשת בסיס לכל ה-webhooks. כתובות ספציפיות לכלי עוקפות את ה-Base URL עבור אותו כלי בלבד. אם אין שימוש ב-n8n ניתן להשאיר ריק." }),
			/* @__PURE__ */ (0, x.jsx)("div", {
				style: E.card,
				children: /* @__PURE__ */ (0, x.jsx)(D, {
					label: "n8n Base URL",
			...
			n.length > 0 && /* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("p", {
				...
				children: n.map((n) => /* @__PURE__ */ (0, x.jsx)(D, {
					label: n,
					children: /* @__PURE__ */ (0, x.jsx)(k, {
						value: e.tools[n],
...
function ye({ form: e, update: t }) {
	...
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		style: E.section,
		children: [
			/* @__PURE__ */ (0, x.jsx)(se, { children: "שולט בהפעלת כלים חיצוניים, סוכן ההתראות וה-Cache — בלי לשנות את כתובות ה-webhooks." }),
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("p", {
				style: E.sectionTitle,
...
function be({ form: e, onApplyPreset: t, onSavePreset: n }) {
	let [r, i] = (0, b.useState)(""), [a, o] = (0, b.useState)(""), s = e.presets || [], c = s.find((e) => e.name === r);
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		style: E.section,
		children: [
			/* @__PURE__ */ (0, x.jsx)(se, { children: "בחירה מהירה של תצורות מוכנות. טעינת פריסט מעדכנת את הטופס בלבד — לחץ \"שמור\" כדי לכתוב ל-Supabase." }),
			/* @__PURE__ */ (0, x.jsxs)("div", {
				style: E.card,
	...
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, x.jsx)(se, { children: "שולט בכמה ידע מקומי נכנס לתכנון החיפוש המקצועי." }),
				/* @__PURE__ */ (0, x.jsx)("div", {
					style: {
						...E.card,
						marginTop: 10
...
function Ce({ variant: e = "secondary", disabled: t = !1, onClick: n, children: r, title: i, style: a }) {
	let [o, s] = (0, b.useState)(!1), c = Se(e, t), l = !t && o ? e === "primary" ? {
...
function we({ sec: e, isActive: t, onSelect: n }) {
...
function Te({ active: e, onSelect: t }) {
	return /* @__PURE__ */ (0, x.jsx)("nav", {
		...
		children: ee.map((n) => /* @__PURE__ */ (0, x.jsx)(we, {
			sec: n,
			isActive: n.id === e,
			onSelect: t
		}, n.id))
...
function Ae() {
	...
	let h = (0, b.useCallback)((e, n) => {
		...
		try {
			let e = await ne("/api/settings/reload", {
				method: "POST",
				body: {}
			});
			e?.settings && (t(w(e.settings)), d({
		...
		try {
			let e = await ne("/api/settings/export"), t = new Blob([JSON.stringify(e, null, 2)], { type: "application/json" }), n = document.createElement("a");
		...
		let r = await n.text();
		try {
			let e = await ne("/api/settings/import", {
				method: "POST",
				body: JSON.parse(r)
			});
			e?.settings && t(w(e.settings));
		} catch {}
		m.current && (m.current.value = "");
	}, ee = async (e) => {
		try {
			let n = await ne("/api/settings/preset/apply", {
				method: "POST",
				body: { name: e }
			});
			n?.settings && t(w(n.settings));
		} catch {}
	}, S = async (t) => {
		try {
			await ne("/api/settings/preset", {
				method: "POST",
				body: {
					name: t,
					settings: ie(e)
		...
		try {
			let e = await ne("/api/openrouter/models");
		...
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsx)(Te, {
					...
					children: [
						o === "connections" && /* @__PURE__ */ (0, x.jsx)(pe, { ...te }),
						o === "agents" && /* @__PURE__ */ (0, x.jsx)(he, {
							...te,
							onRefreshModels: C,
							modelStatus: f
						}),
						o === "retrieval" && /* @__PURE__ */ (0, x.jsx)(ge, { ...te }),
						o === "content" && /* @__PURE__ */ (0, x.jsx)(_e, { ...te }),
						o === "tools" && /* @__PURE__ */ (0, x.jsx)(ve, { ...te }),
						o === "performance" && /* @__PURE__ */ (0, x.jsx)(ye, { ...te }),
						o === "presets" && /* @__PURE__ */ (0, x.jsx)(be, {
							...te,
							onApplyPreset: ee,
							onSavePreset: S
						}),
						o === "general" && /* @__PURE__ */ (0, x.jsx)(xe, { ...te })
					]
				}, o)]
			})
		]
...
function Re({ label: e = "React bridge ready" }) {
	return /* @__PURE__ */ (0, x.jsx)("span", {
...
function Be(e) {
	let t = ze[e.dataset.reactIsland];
	if (!t || Le.has(e)) return !1;
	let n = e.dataset.reactProps ? JSON.parse(e.dataset.reactProps) : {}, r = (0, y.createRoot)(e);
	return r.render(/* @__PURE__ */ (0, x.jsx)(b.StrictMode, { children: /* @__PURE__ */ (0, x.jsx)(t, { ...n }) })), Le.set(e, r), !0;
}
function Ve(e = document) {
	return Array.from(e.querySelectorAll("[data-react-island]")).reduce((e, t) => e + +!!Be(t), 0);
}
typeof window < "u" && (window.BiDocReact = {
	islands: Object.keys(ze),
	mountReactIslands: Ve,
	version: "0.1.0"
}, document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", () => Ve(), { once: !0 }) : Ve());
//#endregion
export { Ve as mountReactIslands };
