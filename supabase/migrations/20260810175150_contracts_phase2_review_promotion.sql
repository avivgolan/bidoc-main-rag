-- BIDoc Contracts Agent Phase 2 reviewed promotion migration.
-- Generated with Supabase CLI 2.113.0 and verified locally before any remote apply.
-- Target on explicit approval only: KAPAIM / APP DATA.
